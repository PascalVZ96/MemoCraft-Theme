...
</style></head><body><div class="wrap"><div class="head"><div><h1>MemoNetwork Inzichten</h1><div class="muted">Live diagnostiek voor processen, netwerk, services en systeemmeldingen</div></div><div class="head-actions"><a class="button" href="/memo-network/system-info.cgi?view=insights">↻ Vernieuwen</a><a class="button" href="/right.cgi">← Dashboard</a></div></div>
INSIGHTS_HEAD
