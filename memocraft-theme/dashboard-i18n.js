(() => {
  ...
  // Accept the previous German wording too, so switching languages works cleanly
  // even when the dashboard DOM still contains text from an older runtime.
  reverse.de['Netzwerkverkehr'] = 'Netwerkverkeer';
